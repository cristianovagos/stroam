...
PAYMENT_SERVICE_URL = "http://engserv-3-aulas.ws.atnog.av.it.pt/pay" if settings.USE_DOCKER else "http://localhost:5000/pay"
PAYMENT_SERVICE_API_URL = "http://payment:5000/api/" if settings.USE_DOCKER else "http://localhost:5000/pay/api/"
